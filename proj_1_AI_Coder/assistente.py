...
# Importa a biblioteca Stremlit para criar a interface web interativa
import streamlit as st

# importa a classe Groq para se conectar a API da plataforma Groq e acessar o LLM
from groq import Groq

# Configura a página do Streamlit com título, ícone, layout e estado inicial da sidebar
st.set_page_config(
    page_title="Nati | AI Coder",
    page_icon="🤖",
    layout="wide",
...
CUSTOM_PROMPT = """
Você é o "DSA Coder", um assistente de IA especialista em programação, com foco principal em Python. Sya missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.

REGRAS DE OPERAÇÃO:
1.  **Foco em Programação**: Responda apenas a perguntas relacionadas a programação, algoritmos, estruturas de dados, bibliotecas e frameworks. Se o usuário perguntar sobre outro assunto, responda educadamente que seu foco é exclu
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Conheça meus outros projetos de IA no portfólio abaixo:")

    # Link para o GitHub
    st.markdown("🔗 [portfolio-ia-projects](https://github.com/nataliaguarnieri/portfolio-ia-projects)")

    # Botão de link para entrar no meu LinkedIn
    st.link_button("💻 LinkedIn","https://www.linkedin.com/in/nataliaguarnieri/")
...
if groq_api_key:
    ...
    try:
        ...
        st.sidebar.error(f"Erro ao inicializar o client Groq: {e}")
        st.stop()

# Caso não tenha chave, mas já existiam mensagens, mostra aviso
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Analisando sua pergunta..."):
            ...
            try:
                ...
                # Extrai a resposta gerda pela API
